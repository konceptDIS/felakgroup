...
<section class="page-header @@extraClassName">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Coporate Governance</h2>
                <ul class="cleenhearts-breadcrumb list-unstyled">
                    <li><i class="icon-home"></i> <a href="{{route('index')}}">Home</a></li>
                    <li><span>Coporate Governance</span></li>
                ...
                <div class="row">
                    ...
                    <div class="help-people__content col-xl-6">
                        <div class="help-people__content__inner">
                            ...
                            <p class="help-people__text1">Felak Concept Group is committed to high standards of corporate governance and strives to ensure that it is practiced throughout the Group to protect and enhance the interest of its stakeholders' value and raise the performance of the Group.

                                We adhere to the tenets of corporate governance to promote excellence, integrity, transparency and accountability which will result to enhanced investors’ confidence.
                                
                                The Board is responsible for the strategic policy direction for the Group and oversees its business operations. It is the collective responsibiity of the board to promote the success and core value of the companies thereby building an enduring, profitable business and also returning dividends to our stakeholders.<br></p>
