...
<section class="page-header @@extraClassName">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Business Conduct and Ethics</h2>
                <ul class="cleenhearts-breadcrumb list-unstyled">
                    <li><i class="icon-home"></i> <a href="{{route('index')}}">Home</a></li>
                    <li><span>Business Conduct and Ethics</span></li>
                    ...
                    <div class="help-people__content col-xl-6">
                        <div class="help-people__content__inner">
                            <div class="sec-title">
                                ...
                                <h3 class="sec-title__title">Our Business Conduct and Ethics</h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <p class="help-people__text1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt facere neque quo sequi eos assumenda sed. Mollitia soluta corrupti veniam saepe eveniet, molestias tempora. Voluptas officiis voluptatibus molestias iure neque culpa ratione cum, nam quod recusandae soluta eos nisi adipisci placeat maxime odio quae dicta esse iusto commodi ipsum obcaecati? Nisi velit recusandae iure quod quasi in hic harum repellendus reiciendis fuga ducimus sint corporis nobis, ex officia dolorem dicta et, obcaecati laboriosam impedit dolore, nesciunt placeat dolorum! Vero hic similique molestias soluta? Tempora illo temporibus eveniet atque sunt, enim nam doloribus nulla iste rerum omnis reprehenderit ab quo voluptatibus?</p>
                    ...
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="about-one__left">
                            <div class="about-one__image">
                                <img src="assets/images/about/about-1-5.png" alt="about" class="about-one__image__one">
