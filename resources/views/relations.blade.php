...
<section class="page-header @@extraClassName">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Investor Relations</h2>
...
<section class="help-people">
            <div class="container">
                <div class="row">
                    ...
                    <div class="help-people__content col-xl-12">
                        <div class="help-people__content__inner">
                            <div class="sec-title">

                                
                                <h3 class="sec-title__title">Contact Investor Relations</h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <form action="#" class="become-volunteer__form form-one">
                                <div class="become-volunteer__form__bg"></div><!-- /.become-volunteer__form__bg -->
                                <h3 class="become-volunteer__form__title"></h3><!-- /.become-volunteer__form__title -->
